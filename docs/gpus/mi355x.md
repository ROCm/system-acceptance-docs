...
- ✅ ROCm 7.0.1 or later installed for MI355X (verify: `cat /opt/rocm/.info/version`)
...
For information on the required single-node and multi-node tests, estimated durations, and test coverage, see [Testing Overview](../index.md#testing-overview) in the Customer Acceptance Guide.
